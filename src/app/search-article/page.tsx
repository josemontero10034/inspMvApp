...
`,
    figures: [
        { url: '/edificio.jpeg', title: 'Vista aérea del área de estudio.', note: 'Fuente: Google Maps, 2023.' },
        { url: '/edificio.jpeg', title: 'Ejemplo de edificación con irregularidades verticales.', note: 'Fotografía tomada por el equipo de investigación.' }
    ]
  },
  {
    label: 'Introducción',
...
`,
    figures: [
        { url: '/edificio.jpeg', title: 'Mapa de zonificación sísmica de la República Dominicana.', note: 'Adaptado del Ministerio de Obras Públicas y Comunicaciones (MOPC), 2011.' },
        { url: '/edificio.jpeg', title: 'Comparativa de diseño estructural pre y post-código sísmico.', note: 'Elaboración propia.' }
    ]
  },
  {
...
`,
    figures: [
        { url: '/edificio.jpeg', title: 'Mapa geológico de la zona de estudio.', note: 'Fuente: Servicio Geológico Nacional.' },
        { url: '/edificio.jpeg', title: 'Falla de Enriquillo-Plantain Garden.', note: 'Fuente: Mann, P., et al. (2002).' }
    ]
  },
  {
...
`,
    figures: [
        { url: '/edificio.jpeg', title: 'Registro histórico de sismicidad.', note: 'Fuente: Instituto Sismológico Universitario.' },
        { url: '/edificio.jpeg', title: 'Edificación construida antes de la normativa vigente.', note: 'Fotografía tomada por el equipo de investigación.' }
    ]
  },
  {
    label: 'Justificación',
...
`,
    figures: [
        { url: '/edificio.jpeg', title: 'Daños estructurales en Haití (2010).', note: 'Fuente: Associated Press.' },
        { url: '/edificio.jpeg', title: 'Modelo de reforzamiento estructural.', note: 'Elaboración propia.' }
    ]
  },
  {
    label: 'Antecedentes',
...
`,
    figures: [
        { url: '/edificio.jpeg', title: 'Portada del manual FEMA P-154.', note: 'Fuente: Federal Emergency Management Agency.' },
        { url: '/edificio.jpeg', title: 'Proyectos de evaluación de ONESVIE.', note: 'Fuente: Oficina Nacional de Evaluación Sísmica y Vulnerabilidad.' }
    ]
  },
  {
    label: 'Objetivos',
...
`,
    figures: [
        { url: '/edificio.jpeg', title: 'Diagrama de flujo de la metodología.', note: 'Elaboración propia.' },
        { url: '/edificio.jpeg', title: 'Ejemplo de formulario de evaluación.', note: 'Adaptado de FEMA P-154.' }
    ]
  },
  {
    ...
    figures: [
        { url: '/edificio.jpeg', title: 'Software Survey123 en uso.', note: 'Captura de pantalla del equipo de campo.' },
        { url: '/edificio.jpeg', title: 'Análisis de datos en software estadístico.', note: 'Elaboración propia.' }
    ]
  },
  {
    label: 'Resultados',
...
`,
    figures: [
        { url: '/edificio.jpeg', title: 'Gráfico de puntajes de vulnerabilidad.', note: 'Resultados del análisis de 50 edificaciones.' },
        { url: '/edificio.jpeg', title: 'Identificación de columna corta en estructura.', note: 'Fotografía tomada por el equipo de investigación.' }
    ]
  },
  {
    label: 'Conclusiones',
...
`,
    figures: [
        { url: '/edificio.jpeg', title: 'Propuesta de reforzamiento con muros de cortante.', note: 'Elaboración propia.' },
        { url: '/edificio.jpeg', title: 'Certificado de capacitación en construcción sismo-resistente.', note: 'Modelo propuesto.' }
    ]
  },
  {
...
const authors: Author[] = [
    {
        ...
        cv: {
            ...
            education: [
                { title: 'Doctorado en Geociencias', institution: 'Universidad de la Tierra', year: '2015' },
                { title: 'Máster en Gestión Ambiental', institution: 'Instituto Global de Sostenibilidad', year: '2011' },
            ],
            experience: [
                { title: 'Consultora Senior', company: 'PNUD', period: '2016 - Presente', description: 'Lidero proyectos de resiliencia hídrica en comunidades vulnerables.' },
                { title: 'Investigadora Asociada', company: 'Centro de Estudios Climáticos', period: '2011 - 2015', description: 'Investigación sobre el impacto del cambio climático en ecosistemas de agua dulce.' },
            ],
            publications: [
    ...
    },
    {
        ...
        cv: {
            ...
            education: [
                { title: 'PhD en Geografía Humana', institution: 'Universidad Internacional', year: '2005' },
            ],
            experience: [
                { title: 'Director de Laboratorio', company: 'Laboratorio de Geoinformática Aplicada', period: '2010 - Presente', description: 'Dirección de investigaciones sobre desarrollo urbano sostenible usando SIG.' },
                { title: 'Profesor Titular', company: 'Departamento de Geografía', period: '2006 - Presente', description: 'Docencia e investigación en geografía y tecnologías geoespaciales.' },
            ],
            publications: [
    ...
    },
      {
        ...
        cv: {
            ...
            education: [
                { title: 'Maestría en Ingeniería Estructural', institution: 'Universidad Politécnica', year: '2018' },
                { title: 'Grado en Ingeniería Civil', institution: 'Universidad Nacional', year: '2016' },
            ],
            experience: [
                { title: 'Ingeniera de Proyectos', company: 'Estructuras Seguras S.A.', period: '2019 - Presente', description: 'Diseño y evaluación de reforzamiento estructural para edificaciones existentes.' },
                { title: 'Voluntaria', company: 'Ingenieros Sin Fronteras', period: '2018 - Presente', description: 'Inspección post-sismo en la región del Caribe.' },
            ],
            publications: [
...
const ApaFigure = ({ figure, number }: { figure: Figure, number: number }) => (
    <Box sx={{ my: 2, textAlign: 'left' }}>
        ...
        <Typography variant="caption" component="p" sx={{ fontStyle: 'italic', mb: 1 }}>
            {figure.title}
        </Typography>
        <Box
            component="img"
            src={figure.url}
            alt={figure.title}
            sx={{ width: '100%', height: 'auto', borderRadius: '4px', border: '1px solid rgba(255,255,255,0.2)' }}
        />
        <Typography variant="caption" component="p" sx={{ mt: 1, fontSize: '0.7rem' }}>
            <Box component="span" sx={{ fontStyle: 'italic' }}>Nota.</Box> {figure.note}
        </Typography>
    </Box>
);
...
export default function InvestigationArticlePage() {
  ...
  return (
    <ThemeProvider theme={theme}>
      <Container maxWidth="xl" sx={{ my: 4, position: 'relative', zIndex: 1 }} className='bg-[url(/edificio.jpeg)] bg-center bg-cover bg-no-repeat bg-fixed'>
        <Paper elevation={6} sx={{ p: { xs: 2, sm: 3, md: 4 }, backdropFilter: 'blur(4px)' }}>
          <Typography 
            variant="h3" 
            component="h1" 
            gutterBottom 
          ...
          EVALUACION SISMICA Y VULNERABILIDAD DE LAS EDIFICACIONES EN EL ENSANCHE QUISQUEYA, SANTO DOMINGO, REP. DOM.
        </Typography>
        <Typography variant="subtitle1" color="text.secondary" gutterBottom align="center" sx={{ mb: 4 }}>
          Un estudio de caso sobre la vulnerabilidad estructural en zonas urbanas de Santo Domingo.
        </Typography>

        <Divider sx={{ my: 4, borderColor: 'primary.main', borderWidth: '1px' }} />

        <Box >
            <Typography variant="h5" component="h2" gutterBottom>Autores</Typography>
            {authors.map((author, index) => (
                ...
                >
                    <Box sx={{ display: 'flex', alignItems: 'center' }}>
                        <Avatar alt={author.name} src={author.avatar} sx={{ width: 60, height: 60, mr: 2 }} />
                        <Box sx={{ flexGrow: 1 }}>
                            <Typography variant="h6" component="h3">{author.name}</Typography>
                            <Typography variant="body2" color="text.secondary">{author.bio}</Typography>
                        </Box>
                        <Button variant="text" onClick={() => handleOpenModal(author)} sx={{ ml: 2, color: 'primary.main', alignSelf: 'center' }}>
                            Leer más
                        </Button>
                    </Box>
                </Box>
        ...
        <Box>
          <Stepper activeStep={activeStep} orientation="vertical">
            {(() => {
              ...
              return articleSteps.map((step, index) => {
                ...
                const figuresToRender = stepFigures.map(fig => ({...fig, number: ++figureCounter}));
              ...
              <Step key={step.label}>
                ...
                >
                  <Typography sx={{ fontSize: '28px', fontWeight: '500', color: 'primary.main' }}>{step.label}</Typography>
                </StepLabel>
                <StepContent>
                  <Slide direction="left" in={activeStep === index} timeout={1000} mountOnEnter unmountOnExit>
                    <Box sx={{ p: 2, borderLeft: `2px solid ${theme.palette.primary.main}`, ml: '12px', pl: 3 }}>
                      <Typography sx={{ whiteSpace: 'pre-line', fontSize: '1rem', lineHeight: 1.75, fontFamily: 'serif', mb: 4, ...(step.label === 'Referencias Bibliográficas' && { textIndent: '-36px', paddingLeft: '36px' }) }}>
                        {step.content}
                      </Typography>
                      ...
                      {stepFigures.length > 0 && (
                        <Grid container spacing={4} sx={{ mt: 2 }}>
                          {figuresToRender.map((fig) => (
                            <Grid item xs={12} sm={6} key={fig.number}>
                              <ApaFigure figure={fig} number={fig.number} />
                            </Grid>
                          ))}
                        </Grid>
                      )}
                      ...
                      <Box sx={{ mb: 2, mt: 2 }}>
                        <div>
                          <Button
                            ...
                            sx={{ mt: 1, mr: 1 }}
                          >
                            {index === articleSteps.length - 1 ? 'Finalizar' : 'Siguiente'}
                          </Button>
                          <Button
                            disabled={index === 0}
                            onClick={handleBack}
          ...
          {activeStep === articleSteps.length && (
            <Paper square elevation={0} sx={{ p: 3, mt: 2, backgroundColor: 'rgba(0,0,0,0.3)' }}>
              <Typography variant='h6' gutterBottom>
                Ha completado la lectura del artículo.
              </Typography>
              <Typography>
                Gracias por revisar el estudio. Puede volver al inicio para leerlo de nuevo.
              </Typography>
        ...
        <Divider sx={{ my: 5, borderColor: 'primary.main', borderWidth: '1px' }} />

        <Box component="section">
            <Typography variant="h5" component="h2" gutterBottom>Discusión y Comentarios</Typography>
            <Box sx={{ my: 3 }}>
                {comments.map((comment, index) => (
                    <Paper key={index} variant="outlined" sx={{ p: 2, mb: 2, backgroundColor: 'rgba(255,255,255,0.05)' }}>
                        <Typography variant="subtitle2" component="p" sx={{ fontWeight: 'bold' }}>{comment.author}</Typography>
                        <Typography variant="caption" color="text.secondary" display="block" gutterBottom>{comment.date}</Typography>
                        <Typography variant="body2">{comment.text}</Typography>
                    </Paper>
                ))}
            </Box>
            <Box component="form" onSubmit={handleCommentSubmit} noValidate sx={{ mt: 1 }}>
                <Typography variant="h6" component="h3" gutterBottom>Dejar un comentario</Typography>
                <TextField
          ...
          <Box sx={modalStyle}>
            {selectedAuthor && (
              <>
                <Grid container>
                  {/* Left Column */}
                  <Grid   size = {12} sx={{ bgcolor: 'primary.main', p: 3, color: 'white' }}>
                    <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center' }}>
                      <Avatar alt={selectedAuthor.name} src={selectedAuthor.avatar} sx={{ width: 150, height: 150, mb: 2, border: '4px solid white' }} />
                      <Typography variant="h4" component="h2" sx={{ fontWeight: 'bold' }}>{selectedAuthor.name}</Typography>
                      <Typography variant="h6" sx={{ mb: 3 }}>{selectedAuthor.cv.specialty}</Typography>
                      
                      <Divider sx={{ bgcolor: 'rgba(255,255,255,0.5)', width: '100%', my: 2 }} />

                      <Typography variant="h6" sx={{ alignSelf: 'flex-start', mb: 1 }}>Contacto</Typography>
                      <Box sx={{ display: 'flex', alignItems: 'center', mb: 1, alignSelf: 'flex-start' }}>
                        <EmailIcon sx={{ mr: 1 }} />
                        <Link href={`mailto:${selectedAuthor.cv.contact.email}`} color="inherit" underline="hover">{selectedAuthor.cv.contact.email}</Link>
                      </Box>
                      <Box sx={{ display: 'flex', alignItems: 'center', alignSelf: 'flex-start' }}>
                        <LinkedInIcon sx={{ mr: 1 }} />
                        <Link href={`https://${selectedAuthor.cv.contact.linkedin}`} target="_blank" rel="noopener" color="inherit" underline="hover">{selectedAuthor.cv.contact.linkedin}</Link>
                      </Box>
                    </Box>
                  </Grid>
                  ...
                  <Grid item xs={12} md={8} sx={{ p: 3 }}>
                    <Box sx={{ mb: 3 }}>
                      <Typography variant="h5" sx={{ color: 'primary.main', borderBottom: 2, borderColor: 'primary.main', pb: 1, mb: 2 }}>Educación</Typography>
                      {selectedAuthor.cv.education.map((edu, index) => (
                        <Box key={index} sx={{ mb: 1.5 }}>
                          <Typography variant="h6" sx={{ fontWeight: 'bold' }}>{edu.title}</Typography>
                          <Typography variant="subtitle1" color="text.secondary">{edu.institution} - {edu.year}</Typography>
                        </Box>
                      ))}
                    </Box>

                    <Box sx={{ mb: 3 }}>
                      <Typography variant="h5" sx={{ color: 'primary.main', borderBottom: 2, borderColor: 'primary.main', pb: 1, mb: 2 }}>Experiencia Profesional</Typography>
                      {selectedAuthor.cv.experience.map((exp, index) => (
                        <Box key={index} sx={{ mb: 2 }}>
                          <Typography variant="h6" sx={{ fontWeight: 'bold' }}>{exp.title} @ {exp.company}</Typography>
                          <Typography variant="caption" color="text.secondary" display="block">{exp.period}</Typography>
                    ...
                    <Box>
                      <Typography variant="h5" sx={{ color: 'primary.main', borderBottom: 2, borderColor: 'primary.main', pb: 1, mb: 2 }}>Publicaciones y Reconocimientos</Typography>
                      {selectedAuthor.cv.publications.map((pub, index) => (
                        <Typography key={index} variant="body2" sx={{ mb: 1 }}>• {pub}</Typography>
                      ))}
                    </Box>
                  </Grid>
                </Grid>
